            ...
            const payloadColor =
              item.payload && typeof item.payload === "object"
                ? ((item.payload as Record<string, unknown>).fill as string | undefined) ??
                  ((item.payload as Record<string, unknown>).color as string | undefined)
                : undefined
            const indicatorColor = color || payloadColor || (item.color as string | undefined)
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: ChartPayloadItem, key: string) {
  ...
  if (typeof payload[key as keyof ChartPayloadItem] === "string") {
